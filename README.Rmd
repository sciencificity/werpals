...
### Example Code
You may run these examples to see the difference in applying these colour scales. In addition use the help functions and navigate to the help section where you will find some examples.
